...
$get_quantity="select * from `cart_details`where u_id=$user_id";
...
if($count_products>0){
    $insert_order="insert into `user_orders` (u_id,amount,invoice_number,total_products,order_date,order_status) values ($user_id,$subtotal,$invoice_number,$count_products,NOW(),'$status')";
    ...
    if($result_query)
    {
        ...
        $insert_view = "INSERT INTO `view` (u_id, p_id, p_name, p_price, p_img, quantity, invoicenumber) VALUES ($user_id, $product_id, '$p_name', $p_price, '$p_img', $quantity, $invoice_number)";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../cart.php">Cart<i class="fas fa-shopping-cart"></i><sup>1</sup></a>
        </li>
      </ul>
...
<nav class="navbar navbar-expand-lg bg-dark  border-bottom border-body" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="user_area/index.php">Home</a>
        </li>
        <?php 
...
<!-- fourth part -->
  ...
  <div class="container product-data">
    ...
    <?php 
      ...
      if($grand>0){
        echo" <div class='row'>
          <div class='col-md-4'>
            <h3 class='bottom_btn mt-2 text-center'>Grand Price:$grand/-</h3>
          </div>
          <div class='col-md-4'>
  ...
  <button class=" btn btn-outline-light text-dark btn">
