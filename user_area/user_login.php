        ...
        <div class="card-body">
          ...
          <form method="post" action="" target="_self" class="needs-validation" novalidate>
            <div class="container">
              ...
              <br><br>
              <p class="text-white">New to E-Mobile ?<br><a href="user_register.php" style="color:rgb(255, 255, 255);">Register Now</a></p>
...
<?php
    ...
    if(isset($_POST['user_login'])){
        $u_name=$_POST['u_name'];
        $u_password=$_POST['u_password1'];
        $select_query="select * from `user_table` where u_name='$u_name'";
        ...
        $role=$row_data['role'];
        if($rows_count>0){
        if(password_verify($u_password,$row_data['u_password'])){
          if($role==1){
