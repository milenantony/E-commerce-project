<?php 
  ...
  if (isset($_SESSION['u_name'])) {
    // User is already logged in, redirect to a welcome page or dashboard
    echo "<script>alert('You are Already Logged in'); window.location.href = 'user_area/index.php';</script>";
    exit();
  }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <ul class="dropdown-menu">
            <?php 
              if(!isset($_SESSION['u_name'])){
                ...
                echo"
                <li><a class='dropdown-item' href='./user_area/profile.php'>My Profile</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="user_area/user_login.php">Cart<i class="fas fa-shopping-cart"></i><sup></sup></a>
        </li>
      </ul>
