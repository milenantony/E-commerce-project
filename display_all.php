      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href='user_area/index.php?c_id=1'>Andriod</a></li>
            <li><a class="dropdown-item" href='user_area/index.php?c_id=2'>iPhone</a></li>
          ...
          <ul class="dropdown-menu">
            ...
            <?php
              ...
              while($row=mysqli_fetch_assoc($result_query)){
                ...
                echo"
                <li><a class='dropdown-item' href='user_area/index.php?b_id=$b_id'>$b_name</a></li>";               
              } 
        ...
        <li class="nav-item">
          <a class="nav-link" href="cart.php">Cart <i class="fas fa-shopping-cart"></i><sup><?php echo "$cartItemCount";?></sup></i></a>
        </li>
      </ul>
